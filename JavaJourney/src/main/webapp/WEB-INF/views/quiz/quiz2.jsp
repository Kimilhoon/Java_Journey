...
$(document).ready(function() {
	...
	$("input[name='grindName']").on('change', function() {
		const checkedCount = $("input[name='grindName']:checked").length;
...
$("#QuizBtn").click(function() {
	...
	$("input[name='grindName']:checked").each(function() {
	...
	location.href = "./quiz3" + queryString;
...
<tr>
	<td>
	<span>굵은 분쇄</span>
	<input type="checkbox" id="grindName1" name="grindName" value="굵은분쇄">
	<span>중간 분쇄</span>
	<input type="checkbox" id="grindName2" name="grindName" value="중간분쇄">
	<span>가는 분쇄</span>
	<input type="checkbox" id="grindName3" name="grindName" value="가는분쇄">
	</td>
</tr>
